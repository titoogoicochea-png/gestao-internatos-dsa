  ...
  return (
    ...
    <div className="flex h-screen flex-col overflow-hidden">
      ...
      <div className="flex min-h-0 flex-1">
        ...
        {sidebarOpen && (
          <aside className="hidden lg:flex lg:w-[28rem] lg:shrink-0 lg:flex-col lg:border-r lg:border-slate-200 lg:bg-white">
            <SidebarContent
              docs={docs}
              active={active}
              lang={lang}
        ...
        <main ref={mainRef} className="min-w-0 flex-1 overflow-y-auto bg-[#EEF1F6]">
          <div className="px-4 py-8 sm:px-8">
            {active && (
              <article className="mx-auto max-w-6xl rounded-2xl border border-slate-200/70 bg-white p-7 shadow-card sm:p-14">
...
function SidebarContent({
  ...
  return (
    <nav className="flex-1 overflow-y-auto px-3 py-4">
      <p className="mb-3 px-2 text-base font-semibold uppercase tracking-wider text-slate-400">
        {t("nav.index")}
      </p>
            ...
            <li key={doc.codigo}>
              ...
              >
                ...
                <button
                  ...
                  className={`flex min-w-0 flex-1 items-center gap-3 px-3 py-3 text-left text-lg ${
                    isActive ? "font-semibold text-brand" : "text-slate-700"
                  }`}
                >
                  {doc.badge ? (
                    <span
                      className={`flex h-8 min-w-[2.1rem] items-center justify-center rounded-md px-1 text-base font-bold shrink-0 ${
                        isActive
                    ...
                    .map((s) => (
                      <li key={s.id}>
                        <a
                          ...
                          className="block truncate rounded px-2 py-1.5 text-base text-slate-500 hover:bg-slate-100 hover:text-brand"
                          title={s.text}
                        >
                          {s.text}
                        </a>
